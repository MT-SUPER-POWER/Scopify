...
const NomandFlutedGlassSettings: React.FC<NomandBackgroundEffectPanelProps> = ({
  ...
  return (
    <div className="space-y-4 rounded-2xl border p-3" style={{ borderColor }}>
      ...
      >
        {t("folia.options.nomandBackgroundEffectFlutedGlass")}
      </div>
      <SliderRow
        {...sliderProps}
        label={t("folia.options.nomandBackgroundFlutedGlassSize")}
      ...
      <SliderRow
        {...sliderProps}
        label={t("folia.options.nomandBackgroundFlutedGlassDistortion")}
      ...
      <SliderRow
        {...sliderProps}
        label={t("folia.options.nomandBackgroundFlutedGlassBlur")}
