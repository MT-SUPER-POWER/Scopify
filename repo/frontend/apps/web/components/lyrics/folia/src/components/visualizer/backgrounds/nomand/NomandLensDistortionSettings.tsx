...
const NomandLensDistortionSettings: React.FC<NomandBackgroundEffectPanelProps> = ({
  ...
  return (
    <div className="space-y-4 rounded-2xl border p-3" style={{ borderColor }}>
      ...
      >
        {t("folia.options.nomandBackgroundEffectLensDistortion")}
      </div>
      <SliderRow
        {...sliderProps}
        label={t("folia.options.nomandBackgroundLensDistortionSpread")}
      ...
      <SliderRow
        {...sliderProps}
        label={t("folia.options.nomandBackgroundLensDistortionBulge")}
      ...
      <SliderRow
        {...sliderProps}
        label={t("folia.options.nomandBackgroundLensDistortionDispersion")}
