...
import { DIORAMA_PARTICLE_AUDIO_SCALE_MAX, type DioramaShapePlacement } from "./cameraPath";
    ...
    shape.kind === "box"
      ...
      : shape.kind === "sphere"
        ...
        : shape.kind === "cone"
          ...
          : 0.9;
  return (
    shape.scale * Math.max(familyRadius, shape.stretchY * 0.55) * DIORAMA_PARTICLE_AUDIO_SCALE_MAX
  );
};

const distanceBetween = (a: DioramaShapePlacement, b: DioramaShapePlacement): number =>
