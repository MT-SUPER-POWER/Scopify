...
const NomandHalftoneDotsSettings: React.FC<NomandBackgroundEffectPanelProps> = ({
  ...
  return (
    <div className="space-y-4 rounded-2xl border p-3" style={{ borderColor }}>
      ...
      >
        {t("folia.options.nomandBackgroundEffectHalftoneDots")}
      </div>
      <SliderRow
        {...sliderProps}
        label={t("folia.options.nomandBackgroundHalftoneDotsSize")}
      ...
      <SliderRow
        {...sliderProps}
        label={t("folia.options.nomandBackgroundHalftoneDotsRadius")}
      ...
      <SliderRow
        {...sliderProps}
        label={t("folia.options.nomandBackgroundHalftoneDotsContrast")}
