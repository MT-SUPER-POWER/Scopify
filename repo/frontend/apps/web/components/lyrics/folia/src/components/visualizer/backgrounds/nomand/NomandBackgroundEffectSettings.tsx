...
const EFFECT_LABEL_KEYS: Record<NomandBackgroundEffect, TranslationKey> = {
  ...
  "halftone-dots": "folia.options.nomandBackgroundEffectHalftoneDots",
  "lens-distortion": "folia.options.nomandBackgroundEffectLensDistortion",
};
    ...
    <div className="space-y-4">
      <div className="space-y-2">
        <div className="text-sm" style={{ color: theme.primaryColor }}>
          {t("folia.options.nomandBackgroundEffect")}
        </div>
