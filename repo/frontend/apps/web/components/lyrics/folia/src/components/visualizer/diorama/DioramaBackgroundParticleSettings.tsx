...
export const DioramaBackgroundParticleSettings: React.FC<
  DioramaBackgroundParticleSettingsProps
> = ({
  label,
  enabled,
  circumference,
  ...
  return (
    <fieldset className="space-y-2.5">
      ...
      {isExpanded && (
        ...
        >
          {renderRange(
            t("folia.options.dioramaMoteCircumference") || "圆周密度",
            circumference,
            DIORAMA_MOTE_CIRCUMFERENCE_MIN,
            DIORAMA_MOTE_CIRCUMFERENCE_MAX,
            DIORAMA_MOTE_CIRCUMFERENCE_STEP,
          ...
          {renderRange(
            t("folia.options.dioramaMoteRadial") || "径向密度",
            radial,
            DIORAMA_MOTE_RADIAL_MIN,
            DIORAMA_MOTE_RADIAL_MAX,
            DIORAMA_MOTE_RADIAL_STEP,
