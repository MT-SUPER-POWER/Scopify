...
import { Theme, DEFAULT_SORA_BACKGROUND_TUNING, type SoraBackgroundTuning } from "../../../../types";
...
const clampTuning = (candidate?: SoraBackgroundTuning): SoraBackgroundTuning => {
  ...
  return {
    ...
    backgroundBrightness: clampValue(candidate?.backgroundBrightness, 0.1, 1, fallback.backgroundBrightness),
  };
};
