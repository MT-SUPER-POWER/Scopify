...
export function AudioEqualizerPanel() {
  ...
  return (
    <div className="space-y-4">
      <div className="border-border bg-muted/20 flex flex-col gap-3 rounded-2xl border p-3 sm:flex-row sm:items-center sm:justify-between">
        <button
          type="button"
      ...
      {activeCustomPreset ? (
        <div className="border-border bg-muted/20 flex flex-col gap-3 rounded-2xl border px-3 py-2.5 sm:flex-row sm:items-center">
          ...
          <div className="flex shrink-0 gap-1.5">
            ...
            <button
              className="border-destructive/40 text-destructive hover:bg-destructive/10 flex size-9 items-center justify-center rounded-xl border transition-colors"
