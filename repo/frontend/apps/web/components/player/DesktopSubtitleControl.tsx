          ...
          <PopoverTrigger asChild>
            <TooltipTrigger asChild>
              <button
                ...
                className={`flex items-center justify-center transition-colors hover:text-content ${control.preferences?.enabled ? "text-brand" : "text-content-muted"}`}
              >
                <Captions className="size-4 lg:size-5" />
              </button>
            </TooltipTrigger>
          </PopoverTrigger>
