...
```tsx
import { Message } from "@scopify/ui/shadcn/components/message"
import {
  MessageScroller,
...
```tsx
import { useMessageScroller } from "@scopify/ui/shadcn/components/message-scroller"
```
...
```tsx
import { useMessageScrollerVisibility } from "@scopify/ui/shadcn/components/message-scroller"
```
...
```tsx
import { useMessageScrollerScrollable } from "@scopify/ui/shadcn/components/message-scroller"
```
