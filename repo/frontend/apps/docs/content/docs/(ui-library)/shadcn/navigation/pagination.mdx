...
<ShadcnOfficialPreview styleName="radix-nova" name="pagination-demo"  />
...
<ShadcnOfficialPreview styleName="radix-nova" name="pagination-simple"  />

## Icons Only

Use just the previous and next buttons without page numbers. This is useful for data tables with a rows per page selector.

<ShadcnOfficialPreview styleName="radix-nova" name="pagination-icons-only"  />
