...
<ShadcnOfficialPreview styleName="radix-nova" name="native-select-demo"  />
...
<ShadcnOfficialPreview styleName="radix-nova" name="native-select-groups"  />

## Disabled

Add the `disabled` prop to the `NativeSelect` component to disable the select.

<ShadcnOfficialPreview styleName="radix-nova" name="native-select-disabled"  />

## Invalid

Use `aria-invalid` to show validation errors and the `data-invalid` attribute to the `Field` component for styling.

<ShadcnOfficialPreview styleName="radix-nova" name="native-select-invalid"  />
