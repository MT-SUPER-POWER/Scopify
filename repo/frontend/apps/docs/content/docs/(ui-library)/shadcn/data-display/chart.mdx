...
import { ChartContainer, ChartTooltipContent } from "@scopify/ui/shadcn/components/chart"
...
```tsx title="components/example-chart.tsx" showLineNumbers
import { type ChartConfig } from "@scopify/ui/shadcn/components/chart"
...
```tsx
import { ChartTooltip, ChartTooltipContent } from "@scopify/ui/shadcn/components/chart"
```
...
```tsx
import { ChartLegend, ChartLegendContent } from "@scopify/ui/shadcn/components/chart"
```
...
<ShadcnOfficialPreview styleName="radix-nova" name="chart-tooltip" hideCode  />
