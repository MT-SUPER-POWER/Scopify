...
import { Bubble, BubbleContent } from "@scopify/ui/shadcn/components/bubble"
import { Message, MessageAvatar, MessageContent } from "@scopify/ui/shadcn/components/message"
```
