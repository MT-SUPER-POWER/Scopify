...
<ShadcnOfficialPreview styleName="radix-nova" name="carousel-size"  />
...
<ShadcnOfficialPreview styleName="radix-nova" name="carousel-spacing"  />
...
import { type CarouselApi } from "@scopify/ui/shadcn/components/carousel"
