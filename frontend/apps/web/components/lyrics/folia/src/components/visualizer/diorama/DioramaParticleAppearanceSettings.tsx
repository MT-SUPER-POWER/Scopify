...
export const DioramaParticleAppearanceSettings: React.FC<DioramaParticleAppearanceSettingsProps> = (
  props,
) => {
  const cardStyle = {
  ...
  return (
    <>
      <div className="rounded-xl px-3 py-2.5 transition-opacity" style={cardStyle}>
        <RangeSetting
          {...sharedRangeProps}
          label={props.t("folia.options.dioramaParticleDensity")}
      ...
      <div className="rounded-xl px-3 py-2.5 transition-opacity" style={cardStyle}>
        <RangeSetting
          {...sharedRangeProps}
          label={props.t("folia.options.dioramaParticleScale")}
      ...
      <div className="space-y-2.5 rounded-xl px-3 py-2.5 transition-opacity" style={cardStyle}>
        <div className="flex items-center justify-between gap-3">
          <div className="min-w-0">
            <div className="text-sm" style={{ color: "var(--text-primary)" }}>
              {props.t("folia.options.dioramaParticleGlow")}
            </div>
          </div>
          <DioramaSettingsToggle
            checked={props.glowEnabled}
            disabled={!props.enabled}
            label={props.t("folia.options.dioramaParticleGlow")}
        ...
        {props.glowEnabled && (
          <RangeSetting
            {...sharedRangeProps}
            label={props.t("folia.options.dioramaParticleGlowIntensity")}
