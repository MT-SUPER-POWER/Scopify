...
import { Song, Album, Playlist, Artist } from "../_types";
...
export function GridCategoryView({
  activeCategory, albums, playlists, artists,
  loadingPlayId, onPlayAlbum, onPlayPlaylist, onNavigate,
}: Props) {
  const isEmpty =
    ...
    <div className="pb-10">
      ...
      {isEmpty && (
        <p className="text-zinc-500 text-sm py-8 text-center">
          No {activeCategory} results found
        </p>
      )}
    </div>
  );
