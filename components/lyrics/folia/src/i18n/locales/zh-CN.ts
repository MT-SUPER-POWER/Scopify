export default {
  ...
  commandPalette: {
    ...
    commands: {
      ...
      "settings-integration": {
        title: "集成设置",
        description: "打开 Stage、Now Playing 和 Navidrome 设置",
      },
      "settings-discord-presence": {
        title: "Discord 播放状态",
        description: "打开 Discord Rich Presence 设置",
      },
      "settings-obs-browser-source": {
        title: "OBS 浏览器源",
        description: "打开 OBS 浏览器源设置",
      },
      ...
      "desktop-toggle-main-window-always-on-top": {
        title: "切换主窗口置顶",
        description: "置顶或取消置顶主窗口",
      },
      "background-monet-full-overlay": {
        title: "背景切换到 莫奈: 全屏叠色",
        description: "切换背景到莫奈全屏叠色",
      },
      "background-monet-half-gradient": {
        title: "背景切换到 莫奈: 半屏渐变",
        description: "切换背景到莫奈半屏渐变",
      },
      "background-common": { title: "背景切换到 通用", description: "切换背景到通用" },
      "background-nomand": {
        title: "背景切换到漫游",
        description: "切换到使用主题配色的像素画背景",
      },
      "background-latent": {
        title: "背景切换到隐现",
        description: "切换到封面取色与音频响应的双着色器背景",
      },
      "background-latent-dithering": {
        title: "背景切换到隐现：像素",
        description: "仅显示 隐现 像素层",
      },
      "background-latent-mesh": {
        title: "背景切换到隐现：流体",
        description: "仅显示 隐现 流体层",
      },
      "background-latent-both": {
        title: "背景切换到隐现：混合",
        description: "同时显示 隐现 像素与流体层",
      },
  ...
  options: {
    ...
    themeLibrary: "主题库",
    themeLibraryDesc: "管理歌词舞台专属的亮色与暗色主题。",
    createTheme: "新建主题",
    deleteTheme: "删除主题",
    resetTheme: "重置此主题",
    restoreBuiltinThemes: "恢复内置主题",
    importThemeJson: "导入主题",
    themeName: "主题名称",
    ...
    themeEdit: "编辑",
    themeImportExport: "导入导出",
    export: "导出",
    import: "导入",
    downloadThemeJson: "下载文件",
    copyFailed: "复制失败",
    pasteJsonOrDropFile: "粘贴 JSON 或拖入文件",
    preview: "预览",
    importThemeName: "主题名称",
    importMode: "导入方式",
    importOverwrite: "覆盖「{{name}}」",
    importAsNew: "新建主题",
    themeOverwritten: "已覆盖主题: {{name}}",
