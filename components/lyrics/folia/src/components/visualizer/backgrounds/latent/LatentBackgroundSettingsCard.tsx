...
const LatentBackgroundSettingsCard: React.FC<LatentBackgroundSettingsCardProps> = ({
  ...
  const displayModes: Array<[LatentBackgroundDisplayMode, string]> = [
    ["dithering", t("folia.options.latentDisplayDithering")],
    ["mesh", t("folia.options.latentDisplayMesh")],
    ["both", t("folia.options.latentDisplayBoth")],
  ];
  const colorSources: Array<[LatentBackgroundColorSource, string]> = [
    ["cover-theme", t("folia.options.latentColorSourceCoverTheme")],
    ["cover-only", t("folia.options.latentColorSourceCoverOnly")],
  ];
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <div className="text-sm" style={{ color: theme.primaryColor }}>
          {t("folia.options.latentColorSource")}
        </div>
      ...
      <BackgroundToggleRow
        label={t("folia.options.latentDynamicOnlyInPlayer")}
        description={t("folia.options.latentDynamicOnlyInPlayerDesc")}
      ...
      <BackgroundToggleRow
        label={t("folia.options.latentEnhancedBeatResponse")}
        description={t("folia.options.latentEnhancedBeatResponseDesc")}
      ...
      <div className="space-y-3 rounded-2xl border p-3" style={{ borderColor }}>
        <BackgroundToggleRow
          label={t("folia.options.nomandBackgroundOverlay")}
          description={t("folia.options.nomandBackgroundOverlayDesc")}
        ...
        <div className={tuning.overlayEnabled ? "" : "opacity-45"}>
          <SliderRow
            {...sharedSliderProps}
            label={t("folia.options.nomandBackgroundOverlayOpacity")}
      ...
      <div className="space-y-4 rounded-2xl border p-3" style={{ borderColor }}>
        ...
        >
          {t("folia.options.latentDitheringGroup")}
        </div>
        <SliderRow
          {...sharedSliderProps}
          label={t("folia.options.latentBaseSpeed")}
        ...
        <SliderRow
          {...sharedSliderProps}
          label={t("folia.options.latentAudioSpeed")}
        ...
        <SliderRow
          {...sharedSliderProps}
          label={t("folia.options.latentDitheringSize")}
        ...
        <SliderRow
          {...sharedSliderProps}
          label={t("folia.options.latentDitheringOpacity")}
      ...
      <div className="space-y-4 rounded-2xl border p-3" style={{ borderColor }}>
        <div
          ...
          style={{ color: theme.secondaryColor }}
        >
          {t("folia.options.latentMeshGroup")}
        </div>
        <SliderRow
          {...sharedSliderProps}
          label={t("folia.options.latentBaseSpeed")}
        ...
        <SliderRow
          {...sharedSliderProps}
          label={t("folia.options.latentMeshDistortion")}
        ...
        <SliderRow
          {...sharedSliderProps}
          label={t("folia.options.latentMeshSwirl")}
