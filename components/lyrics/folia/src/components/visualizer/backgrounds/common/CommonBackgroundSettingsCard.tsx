...
const CommonBackgroundSettingsCard: React.FC<VisualizerBackgroundSettingsProps> = ({
  ...
  return (
    <>
      ...
      >
        <BackgroundToggleRow
          label={t("folia.options.disableVisualizerVignette")}
          description={t("folia.options.disableVisualizerVignetteDesc")}
          checked={common?.disableVignette ?? false}
          onChange={commonActions?.onDisableVignetteChange}
          theme={theme}
        />
        <BackgroundToggleRow
          label={t("folia.options.disableVisualizerGeometricBackground")}
          description={t("folia.options.disableVisualizerGeometricBackgroundDesc")}
      ...
      >
        <div className="space-y-2">
          <div className="text-sm font-medium" style={{ color: theme.primaryColor }}>
            {t("folia.options.previewCoverBackgroundSettings")}
          </div>
          <div className="text-xs opacity-70" style={{ color: theme.secondaryColor }}>
            {t("folia.options.previewCoverBackgroundSettingsDesc")}
          </div>
          <BackgroundToggleRow
            label={t("folia.theme.addCoverColor")}
            description={t("folia.options.coverColorBackgroundDesc")}
          ...
          >
            <span>{t("folia.options.previewCoverBackgroundOpacity")}</span>
