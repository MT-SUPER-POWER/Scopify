...
import { type VisualizerEntryModule, type VisualizerRegistryEntry } from "./definition";
import cadenzaEntry from "./cadenza/entry";
import cappellaEntry from "./cappella/entry";
import claddaghEntry from "./claddagh/entry";
import classicEntry from "./classic/entry";
import dioramaEntry from "./diorama/entry";
...
const visualizerEntryModules: Record<string, VisualizerEntryModule> = {
  ...
  "./classic/entry.tsx": { default: classicEntry },
  "./diorama/entry.tsx": { default: dioramaEntry },
  "./fume/entry.tsx": { default: fumeEntry },
...
export const getVisualizerModeLabel = (
  mode: VisualizerMode,
