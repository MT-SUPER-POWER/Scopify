...
import { type DioramaGeometryVisibility, type Theme } from "../../../types";
...
const CHILDREN: Array<{ key: GeometryChildKey; labelKey: TranslationKey }> = [
  { key: "strands", labelKey: "folia.options.dioramaGeometryStrands" },
  { key: "blobs", labelKey: "folia.options.dioramaGeometryBlobs" },
  { key: "ribbons", labelKey: "folia.options.dioramaGeometryRibbons" },
  { key: "rings", labelKey: "folia.options.dioramaGeometryRings" },
];

const MODES: Array<{ key: DioramaGeometryVisibility["mode"]; labelKey: TranslationKey }> = [
  { key: "clouds", labelKey: "folia.options.dioramaGeometryModeClouds" },
  { key: "corridor", labelKey: "folia.options.dioramaGeometryModeCorridor" },
];
...
export const DioramaGeometrySettings: React.FC<DioramaGeometrySettingsProps> = ({
  ...
  return (
    <fieldset className="space-y-2.5">
      <legend className="sr-only">{t("folia.options.dioramaGeometry")}</legend>
      <div
        ...
        >
          ...
          <span className="min-w-0">
            <span className="block text-sm font-medium" style={{ color: "var(--text-primary)" }}>
              {t("folia.options.dioramaGeometry")}
            </span>
          </span>
        </button>
        <DioramaSettingsToggle
          checked={value.enabled}
          label={t("folia.options.dioramaGeometry")}
      ...
      {isExpanded && (
        ...
        >
          ...
          <div
            ...
            role="group"
            aria-label={t("folia.options.dioramaGeometryMode")}
            ...
            {MODES.map((item) => {
              ...
              return (
                <button
                  ...
                  className="flex-1 rounded-xl border px-3 py-2 text-sm transition-all disabled:cursor-not-allowed"
                  style={{
