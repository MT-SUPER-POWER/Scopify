...
const LyricsTimelineModal: React.FC<LyricsTimelineModalProps> = ({
  ...
  useMotionValueEvent(currentTime, "change", (latest) => {
    ...
    const index = lyrics.lines.findIndex(
      (line) => latest >= line.startTime && latest <= line.endTime,
    );
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className={`h-[80vh] w-[90vw] max-w-4xl ${glassBg} border ${borderColor} relative flex flex-col rounded-2xl p-8`}
          ...
          >
            ...
            <div
              ...
              className="flex-1 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent overflow-x-hidden overflow-y-auto px-8"
              style={{
                scrollbarWidth: "thin",
            ...
            >
              {dots.length > 0 ? (
                <div className="relative py-8">
                  ...
                  {dots.map((dot, index) => {
                    ...
                    return (
                      ...
                      >
                        {/* Left side content */}
                        <div className="flex w-1/2 justify-end pr-4 max-md:hidden">
                          {isLeft && (
                            <motion.div
                              animate={{
                            ...
                            >
                              <div
                                className={`inline-block ${itemBg} border backdrop-blur-xl ${itemBorder} rounded-lg p-6 ${disabledCursorClass} ${disabledItemClass} ${disabled ? "" : itemHoverBg} transition-all`}
                                onClick={() => {
                              ...
                              >
                                <div className="text-right">
                                  <p
                                    className={`${itemTextPrimary} font-medium transition-all ${
                                  ...
                                  {dot.translation && (
                                    <p
                                      className={`${itemTextSecondary} mt-1 transition-all ${
                        ...
                        {/* Right side content */}
                        <div className="flex w-1/2 justify-start pl-4 max-md:hidden">
                          {!isLeft && (
                            <motion.div
                              animate={{
                                scale: isActive ? 1 : 0.85,
                        ...
                        <motion.div
                          ...
                          transition={{ duration: 0.3 }}
                          className="absolute right-0 left-6 hidden max-md:block"
                        >
                          <div
                            className={`${itemBg} border backdrop-blur-xl ${itemBorder} rounded-lg p-4 ${disabledCursorClass} ${disabledItemClass} ${disabled ? "" : itemHoverBg} transition-all`}
                            onClick={() => {
                              handleSeek(dot.startTime);
                            }}
                          >
                ...
                <div className={`flex h-full items-center justify-center ${itemTextSecondary}`}>
                  {t("folia.timeline.noLyrics")}
                </div>
              )}
            </div>
          </motion.div>
