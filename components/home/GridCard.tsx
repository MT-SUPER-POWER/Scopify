...
export function GridCard({ id, name, coverUrl, subtitle, playCount, isLoading, isArtist, onPlay, onClick }: GridCardProps) {
  return (
    <div key={id} onClick={onClick}
      ...
      <div className="relative mb-4">
        <div className={cn("w-full aspect-square rounded-md overflow-hidden bg-zinc-800 shadow-lg", isArtist && "rounded-full")}>
          <Image width={200} height={200} src={coverUrl || ""} alt={name}
