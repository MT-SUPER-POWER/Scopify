  ...
  return (
    <div className="grid w-full min-w-0 grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-6">
      {Array.from({ length: CARD_COUNT }, (_, index) => (
        <div key={index} className="rounded-xl bg-[#181818] p-4">
