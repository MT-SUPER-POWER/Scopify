...
export const LibraryItem = ({
  ...
  if (isCollapsed) {
    return (
      <Link href={href} className="flex items-center justify-center w-full h-14 hover:bg-[#1a1a1a] rounded-md transition-colors cursor-pointer active:scale-95 group">
  ...
  return (
    <Link href={href} className="flex items-center gap-3 p-2 hover:bg-[#1a1a1a] rounded-md cursor-pointer transition-colors group">
