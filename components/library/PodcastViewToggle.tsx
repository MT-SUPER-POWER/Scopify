      ...
      {(["list", "cards"] as PodcastViewMode[]).map((view) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex size-8 items-center justify-center rounded-sm text-zinc-400 transition-colors hover:text-white",
              isActive && "bg-white text-zinc-950 hover:text-zinc-950",
            )}
          >
