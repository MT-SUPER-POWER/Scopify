    ...
    <div className={
      ...
      <div className="flex items-center justify-between mt-2 pt-2 border-t border-white/10">
        <div className="flex gap-4 text-[#B3B3B3]">
          <button onClick={() => { editorRef.current?.focus(); document.execCommand('insertText', false, "#TOPIC#"); handleInput(); }}>
            <Hash className="w-5 h-5 hover:text-white cursor-pointer transition-colors" />
          </button>
          <button onClick={() => { editorRef.current?.focus(); document.execCommand('insertText', false, "@USER_NAME "); handleInput(); }}>
