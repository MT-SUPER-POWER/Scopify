    ...
    <div className="flex-1 pb-6 border-b border-white/5 group-last:border-0">
      ...
      <div className="flex items-center justify-between mt-3">
        <div className="flex gap-4 opacity-0 group-hover:opacity-100 transition-opacity">
          <button
            onClick={() => onReply && onReply(comment.commentId)}
        ...
        <div className="flex items-center gap-6 text-[#B3B3B3]">
          ...
          <LikeButton
            ...
            onLike={() => onLike && onLike(comment.commentId, isHot)}
          />
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-32 bg-[#282828] border-white/10 text-white">

              {/* 举报 */}
              <DropdownMenuItem
                onClick={() => onReport && onReport(comment.commentId)}
              ...
              {/* 删除评论 */}
              <DropdownMenuItem
                onClick={() => onDelete && onDelete(comment.commentId)}
