...
- [x] 使用过多的 `any` 了，是時候還債了   // TODO: P0
- [x] 日志系统不完善的问题               // TODO: P0
  - [x] web Debug 的时候，nextjs 的报错输入之类的不显示到终端，也不记录到我们的日志文件，这个有点头疼
  - [x] 各类网络请求的错误的详细错误结果都是 console.log 也不走到我们的日志记录文件
- [x] TanStack Query 功能补全          // TODO: P1
